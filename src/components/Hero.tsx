    ...
    <div className="bg-[#E3EDF6] mt-4 h-50">
      <div className="container grid md:grid-cols-2  py-8">
        <div className="flex items-center  justify-center">
          <div className="max-w-[450px] space-y-4 mb-4">
        ...
        <div>
          <img
            className=" mx-auto lg:ml-auto lg:mr-auto"
            src="https://rukminim2.flixcart.com/image/416/416/xif0q/tablet/0/i/l/vhu4406in-xiaomi-original-imagtz62xc2vcuca.jpeg?q=70&crop=false"
            alt="tab"
          />
        </div>
      </div>
